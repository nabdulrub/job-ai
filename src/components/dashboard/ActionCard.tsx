...
const ActionCard = ({
  ...
  return (
    <Card className=" relative flex-1 flex flex-col justify-end shadow-none h-[250px] max-w-[400px] rounded-[20px] bg-gradient-to-r from-gray-100 via-white to-gray-300  border-[1px] border-gray-300">
      <div
