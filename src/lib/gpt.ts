...
export const tailorJob = async () => {
  const chatCompletion = await openai.chat.completions.create({
    ...
    messages: [
      ...
      {
        role: "user",
        content: `Tailor my resume with the following job experience: ${jobExperience}, project experience ${projectExperience}, education: ${education}, my info ${info}, my skills: ${skills} to this job description ${jobPost}. Highlight my best skills, job experiences and projects. Add other skills that might increase my chances of getting the job, but ensure they are related to my experience, limit the total skills to 10!`,
      },
    ],
    model: "gpt-3.5-turbo",
